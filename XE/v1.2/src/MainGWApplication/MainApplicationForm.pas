               ...
               begin
                ...
                begin
                 try
                  ...
                  OPDSCreenCDS.Post;
                 Except
                    FormMainApplication.MemoError.Lines.Add('Fields '+field+' ในตาราง opdscreen ไม่มี ');
                 end;
                end;
      ...
      if cdsLabTrack.Active then
        ...
        begin
          ...
          begin
            ...
            //HOSxP_gwGetLabOrderType(cdsLabTrack.FieldByName('lab_lis_track_type').asstring,cdsLabTrack.FieldByName('lab_lis_track_id').AsInteger,hospitalcode,DeCryptText);
               ...
               if cdsHosLabTrack.Active then
                 ...
                 begin
                  ...
                  begin
                    ...
                    if cdsUpdateGatewayTrack.Active then
                      if cdsUpdateGatewayTrack.RecordCount<=0 then
                        cdsUpdateGatewayTrack.FieldByName('lab_lis_accept_number').AsInteger :=  HOSxP_gwGetSerialNumber('lab_receive_number');
